...
function getWProduct()
{
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        <div class='pi-pic' style='max-height:300px'>
            ...
            <ul>
                <li class='quick-view'><a href='product.php?product_id=$products_id' style='background:#fe4231;color:white'>View product</a></li>
            </ul>
        </div>
        <div class='pi-text'>
        ...
        <div class='col-lg-3 col-sm-6'>
            <div class='product-item' >
                <div class='pi-pic' style='max-height:300px'>
                    ...
                    <ul>
                        <li class='quick-view'><a href='product.php?product_id=$p_id' style='background:#fe4231;color:white'>View product</a></li>
                    </ul>
                </div>
                <div class='pi-text'>
                    <a href='#'>
